...
export default function CreateVisitor({ apartments, visitorTypes }: { apartments: Apartment[]; visitorTypes: VisitorType[] }) {
                ...
                >
                    ...
                    <div className="grid gap-2">
                        ...
                        <Textarea
                            ...
                            placeholder="e.g. Meeting resident, delivery, maintenance"
                            rows={2}
                        />
...
CreateVisitor.layout = {
    breadcrumbs: [
        { title: 'Dashboard', href: '/' },
        { title: 'Visitors', href: '/visitors' },
        { title: 'New', href: '/visitors/create' },
    ],
};
