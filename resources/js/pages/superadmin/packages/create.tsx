...
import { index, store } from '@/routes/superadmin/packages';
...
export default function PackageCreate({
    ...
    const { data, setData, post, processing, errors } = useForm<PackageData>({
        package_name: '',
        description: '',
    ...
    return (
        <>
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading title="Create Package" description="Add a new subscription package" />
                ...
                >
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            required
                            placeholder="e.g. Premium Society"
                        />
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Create package</Button>
