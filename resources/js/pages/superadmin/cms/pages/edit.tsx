...
import { edit, index, update } from '@/routes/superadmin/cms/pages';
...
type Page = PageData & { id: number };

export default function CmsPageEdit({ page }: { page: Page }) {
    const { data, setData, put, processing, errors } = useForm<PageData>({
        title: page.title,
        slug: page.slug,
    ...
    return (
        <>
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading title="Edit Page" description={page.title} />
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Update page</Button>
