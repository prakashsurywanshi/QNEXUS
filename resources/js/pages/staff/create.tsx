...
export default function CreateStaff() {
    const { data, setData, post, processing, errors } = useForm<StaffData>({
        name: '',
        phone: '',
        email: '',
        designation: '',
        ...
        <>
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading
                    variant="small"
                    title="Add Staff"
                    description="Add a staff member to the society"
                />
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Add Staff</Button>
                    </div>
                </form>
            </div>
        </>
