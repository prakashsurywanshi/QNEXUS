...
export default function CreateInvoice({
    ...
    const { data, setData, post, processing, errors } = useForm<InvoiceData>({
        lease_agreement_id: '',
        invoice_number: '',
        billing_period: '',
        rent_amount: '0',
    ...
    return (
        <>
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading variant="small" title="Add Invoice" description="Create a rent invoice" />
                <form onSubmit={save} className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input id="billing_period" name="billing_period" value={data.billing_period} onChange={(e) => setData('billing_period', e.target.value)} required placeholder="e.g. September 2026" />
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Save invoice</Button>
                    </div>
                </form>
            </div>
        </>
