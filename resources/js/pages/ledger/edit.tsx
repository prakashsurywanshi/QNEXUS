...
import { update } from '@/routes/ledger';
...
export default function EditEntry({
    ...
    const { data, setData, put, processing, errors } = useForm<EntryData>({
    ...
    return (
        <>
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading variant="small" title="Edit Ledger Entry" description="Update the ledger entry" />
