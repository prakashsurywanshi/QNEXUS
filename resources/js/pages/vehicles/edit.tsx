...
export default function EditVehicle({
    ...
    vehicle: { id: number; apartment: { id: number; apartment_number: string } | null; owner: { id: number; name: string } | null; parkingSlot: { id: number; parking_code: string } | null } & Omit<VehicleData, 'apartment_management_id' | 'owner_user_id' | 'parking_management_id'>;
    users: User[];
    apartments: Apartment[];
    parkingSlots: ParkingSlot[];
}) {
    const { data, setData, put, processing, errors } = useForm<VehicleData>({
        apartment_management_id: vehicle.apartment ? String(vehicle.apartment.id) : '',
        owner_user_id: vehicle.owner ? String(vehicle.owner.id) : '',
        ...
        parking_management_id: vehicle.parkingSlot ? String(vehicle.parkingSlot.id) : '',
        ...
        <>
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading
                    variant="small"
                    title="Edit Vehicle"
                    description="Update vehicle and parking details"
                />
