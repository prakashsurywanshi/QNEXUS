...
export default function CreateAsset({
    ...
    const { data, setData, post, processing, errors } = useForm<AssetData>({
        name: '',
        category_id: '',
        location: '',
        condition: '',
        ...
        <>
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading
                    variant="small"
                    title="Add Asset"
                    description="Register a new asset for this society"
                />
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Save asset</Button>
                    </div>
                </form>
            </div>
        </>
