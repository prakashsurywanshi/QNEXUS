...
export default function CreateVendorPayment({ vendors }: { vendors: Vendor[] }) {
...
CreateVendorPayment.layout = {
    breadcrumbs: [
        { title: 'Dashboard', href: '/' },
        { title: 'Vendor Payments', href: '/vendor-payments' },
        { title: 'New', href: '/vendor-payments/create' },
    ],
};
