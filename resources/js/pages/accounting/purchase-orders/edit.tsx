...
type Item = { item_name: string; description: string; quantity: string; unit: string; unit_price: string };
...
export default function EditPurchaseOrder({
    ...
    const { data, setData, put, processing, errors } = useForm<PurchaseOrderData>({
        ...
        status: purchaseOrder.status as PurchaseOrderData['status'],
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Update Purchase Order</Button>
                    </div>
                </form>
            </div>
        </>
