...
export default function EditFixedDeposit({ deposit }: { deposit: DepositData & { id: number } }) {
    const { data, setData, put, processing, errors } = useForm<DepositData>({
        ...
        renewal_action: deposit.renewal_action ?? '',
    });

    return (
        <>
            <Head title="Edit Fixed Deposit" />
            ...
            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Update Fixed Deposit</Button>
                    </div>
                </form>
            </div>
        </>
