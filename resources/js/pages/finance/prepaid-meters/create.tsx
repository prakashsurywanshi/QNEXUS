...
export default function CreatePrepaidMeter({ apartments }: { apartments: Apartment[] }) {
    const { data, setData, post, processing, errors } = useForm<MeterData>({
        apartment_id: '',
        meter_number: '',
        meter_type: 'electric',
        is_active: true,
    ...
    return (
        <>
            <Head title="New Prepaid Meter" />

            <div className="mx-auto flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading
                    variant="small"
                    title="New Prepaid Meter"
                    description="Register a utility meter"
                />
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <Button disabled={processing}>Create Meter</Button>
                    </div>
                </form>
            </div>
        </>
...
CreatePrepaidMeter.layout = {
    breadcrumbs: [
        { title: 'Dashboard', href: '/' },
        { title: 'Prepaid Meters', href: '/prepaid-meters' },
        { title: 'New', href: '/prepaid-meters/create' },
    ],
};
